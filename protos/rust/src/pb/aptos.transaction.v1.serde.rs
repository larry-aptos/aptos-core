...
impl serde::Serialize for Block {
        ...
        S: serde::Serializer,
    {
        ...
        if self.epoch3 != 0 {
            struct_ser.serialize_field("epoch3", &self.epoch3)?;
        }
        struct_ser.end()
    }
}
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "epoch3" => Ok(GeneratedField::Epoch3),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::Epoch3 => {
                            if epoch3__.is_some() {
                                return Err(serde::de::Error::duplicate_field("epoch3"));
                            }
                            epoch3__ =
                                Some(map.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                ...
                Ok(Block {
                    ...
                    epoch3: epoch3__.unwrap_or_default(),
                })
            }
        }
